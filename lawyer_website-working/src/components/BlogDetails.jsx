...
const BlogDetails = () => {
    ...
    const { BlogDetails, categoryBtnData } = blogsDetailsData;
    
    const { img, date, title, description, subTitle, description2, sections } = BlogDetails
    return (
        <section>
            ...
            <div className="flex flex-col-reverse lg:flex-row gap-4 mb-10 lg:w-10/12 mx-auto px-2 lg:px-0">
                <div className="lg:w-2/3 ">
                    ...
                    <div className="border-2 px-3 space-y-3">
                        ...
                        {/* <div className="flex items- items-start gap-3">
                           ...
                           <div>
                            <p className="text-bla font-bold">Albert Flores</p>
                            <p className="">May 25, 2023 at 5:48 am</p>
                            <p className="text-bla font-bold">Albert Flores</p>
                           </div>
                        </div> */}
                ...
                <div className="lg:w-[520px] border border-green-700">
