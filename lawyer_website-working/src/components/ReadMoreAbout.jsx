...
const ReadMoreAbout = () => {
    return (
        <section className='px-2 lg:border-2 md:border-dashed  lg:px-0 lg:w-10/12 mx-auto mt-16'>
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="md:flex-1 border-r-2 border-dashed">
                    <img src={aboutImg} alt="" />
                </div>
                <div className="md:flex-1">
                    <p className='text-bla font-bold text-xl'>About Us</p>
